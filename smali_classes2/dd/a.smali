...
.method public static d(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILad/b;)V
    .locals 8
    ...
    invoke-direct/range {v0 .. v6}, Lcd/a;-><init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILad/b;)V
...
.method public static g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {v1, p0}, Ldd/f;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {v1}, Ldd/f;->c()I

    move-result v0

    invoke-static {p0}, Ldd/a;->c(Ljava/io/Closeable;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
