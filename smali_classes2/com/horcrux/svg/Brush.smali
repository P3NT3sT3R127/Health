...
# instance fields
.field private final a:Lcom/horcrux/svg/Brush$BrushType;
...
.field private h:Lcom/horcrux/svg/t;
...
.method private a(Landroid/graphics/RectF;)Landroid/graphics/RectF;
    ...
    iget-boolean v0, p0, Lcom/horcrux/svg/Brush;->d:Z
    ...
    iget-object v0, p0, Lcom/horcrux/svg/Brush;->g:Landroid/graphics/Rect;
    ...
    iget-boolean v2, p0, Lcom/horcrux/svg/Brush;->d:Z
...
.method private b(Lcom/horcrux/svg/SVGLength;DFF)D
    ...
    invoke-static/range {v2 .. v10}, Lcom/horcrux/svg/v;->a(Lcom/horcrux/svg/SVGLength;DDDD)D
...
# virtual methods
.method d(Lcom/horcrux/svg/Brush$BrushUnits;)V
    .locals 1
    ...
    :goto_0
    iput-boolean p1, p0, Lcom/horcrux/svg/Brush;->e:Z
...
.method e(Lcom/facebook/react/bridge/ReadableArray;)V
    ...
    iput-object p1, p0, Lcom/horcrux/svg/Brush;->c:Lcom/facebook/react/bridge/ReadableArray;
...
.method f(Landroid/graphics/Matrix;)V
    ...
    iput-object p1, p0, Lcom/horcrux/svg/Brush;->f:Landroid/graphics/Matrix;

    return-void
.end method

.method g(Lcom/horcrux/svg/t;)V
    .locals 0

    iput-object p1, p0, Lcom/horcrux/svg/Brush;->h:Lcom/horcrux/svg/t;
...
.method h(Landroid/graphics/Rect;)V
    ...
    iput-object p1, p0, Lcom/horcrux/svg/Brush;->g:Landroid/graphics/Rect;
...
.method i(Landroid/graphics/Paint;Landroid/graphics/RectF;FF)V
    ...
    invoke-direct {v6, v0}, Lcom/horcrux/svg/Brush;->a(Landroid/graphics/RectF;)Landroid/graphics/RectF;
    ...
    iget-object v0, v6, Lcom/horcrux/svg/Brush;->a:Lcom/horcrux/svg/Brush$BrushType;
    ...
    iget-object v0, v6, Lcom/horcrux/svg/Brush;->b:[Lcom/horcrux/svg/SVGLength;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/horcrux/svg/Brush;->b(Lcom/horcrux/svg/SVGLength;DFF)D
    ...
    iget-object v4, v6, Lcom/horcrux/svg/Brush;->h:Lcom/horcrux/svg/t;

    invoke-virtual {v4}, Lcom/horcrux/svg/t;->getViewBox()Landroid/graphics/RectF;
    ...
    iget-object v0, v6, Lcom/horcrux/svg/Brush;->h:Lcom/horcrux/svg/t;

    iget-object v1, v0, Lcom/horcrux/svg/t;->s:Ljava/lang/String;

    iget v0, v0, Lcom/horcrux/svg/t;->t:I

    invoke-static {v4, v5, v1, v0}, Lcom/horcrux/svg/f0;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;Ljava/lang/String;I)Landroid/graphics/Matrix;
    ...
    :cond_1
    iget-boolean v0, v6, Lcom/horcrux/svg/Brush;->e:Z
    ...
    invoke-virtual {v0, v3, v1, v4}, Lcom/horcrux/svg/j;->draw(Landroid/graphics/Canvas;Landroid/graphics/Paint;F)V

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iget-object v1, v6, Lcom/horcrux/svg/Brush;->f:Landroid/graphics/Matrix;
    ...
    iget-object v0, v6, Lcom/horcrux/svg/Brush;->c:Lcom/facebook/react/bridge/ReadableArray;
    ...
    invoke-static {v1, v0}, Lw2/a;->K(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v8, v6, Lcom/horcrux/svg/Brush;->c:Lcom/facebook/react/bridge/ReadableArray;

    invoke-static {v8, v0, v5, v3, v4}, Lcom/horcrux/svg/Brush;->c(Lcom/facebook/react/bridge/ReadableArray;I[F[IF)V
    ...
    invoke-static {v1, v4}, Lw2/a;->K(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, v6, Lcom/horcrux/svg/Brush;->f:Landroid/graphics/Matrix;
