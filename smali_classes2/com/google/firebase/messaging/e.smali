...
.field private final c:Lcom/google/firebase/messaging/k0;
...
.method public constructor <init>(Landroid/content/Context;Lcom/google/firebase/messaging/k0;Ljava/util/concurrent/ExecutorService;)V
    ...
    iput-object p2, p0, Lcom/google/firebase/messaging/e;->c:Lcom/google/firebase/messaging/k0;
...
.method private d()Lcom/google/firebase/messaging/g0;
    .locals 2

    iget-object v0, p0, Lcom/google/firebase/messaging/e;->c:Lcom/google/firebase/messaging/k0;

    const-string v1, "gcm.n.image"

    invoke-virtual {v0, v1}, Lcom/google/firebase/messaging/k0;->p(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, Lcom/google/firebase/messaging/g0;->e(Ljava/lang/String;)Lcom/google/firebase/messaging/g0;
    ...
    invoke-virtual {v0, v1}, Lcom/google/firebase/messaging/g0;->h(Ljava/util/concurrent/ExecutorService;)V

    :cond_0
    return-object v0
.end method

.method private e(Landroidx/core/app/k$e;Lcom/google/firebase/messaging/g0;)V
    .locals 5
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p2}, Lcom/google/firebase/messaging/g0;->f()Lcom/google/android/gms/tasks/Task;
    ...
    invoke-virtual {p1, v1}, Landroidx/core/app/k$e;->v(Landroid/graphics/Bitmap;)Landroidx/core/app/k$e;

    new-instance v2, Landroidx/core/app/k$b;

    invoke-direct {v2}, Landroidx/core/app/k$b;-><init>()V

    invoke-virtual {v2, v1}, Landroidx/core/app/k$b;->i(Landroid/graphics/Bitmap;)Landroidx/core/app/k$b;

    move-result-object v1

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Landroidx/core/app/k$b;->h(Landroid/graphics/Bitmap;)Landroidx/core/app/k$b;

    move-result-object v1

    invoke-virtual {p1, v1}, Landroidx/core/app/k$e;->G(Landroidx/core/app/k$h;)Landroidx/core/app/k$e;
    :try_end_0
...
.method a()Z
    ...
    invoke-virtual {v0, v1}, Lcom/google/firebase/messaging/k0;->a(Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-direct {p0}, Lcom/google/firebase/messaging/e;->d()Lcom/google/firebase/messaging/g0;

    move-result-object v0

    iget-object v2, p0, Lcom/google/firebase/messaging/e;->b:Landroid/content/Context;

    iget-object v3, p0, Lcom/google/firebase/messaging/e;->c:Lcom/google/firebase/messaging/k0;

    invoke-static {v2, v3}, Lcom/google/firebase/messaging/c;->e(Landroid/content/Context;Lcom/google/firebase/messaging/k0;)Lcom/google/firebase/messaging/c$a;

    move-result-object v2

    iget-object v3, v2, Lcom/google/firebase/messaging/c$a;->a:Landroidx/core/app/k$e;

    invoke-direct {p0, v3, v0}, Lcom/google/firebase/messaging/e;->e(Landroidx/core/app/k$e;Lcom/google/firebase/messaging/g0;)V
