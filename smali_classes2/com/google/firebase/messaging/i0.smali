...
.method public static A(Landroid/content/Intent;)Z
    ...
    invoke-static {p0}, Lcom/google/firebase/messaging/i0;->r(Landroid/content/Intent;)Z
...
.method public static B(Landroid/content/Intent;)Z
    ...
    invoke-static {p0}, Lcom/google/firebase/messaging/i0;->C(Landroid/os/Bundle;)Z
...
.method static a()Z
    ...
    invoke-virtual {v2}, Lcom/google/firebase/f;->m()Landroid/content/Context;
...
.method static b(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;)Lcom/google/firebase/messaging/reporting/MessagingClientEvent;
    ...
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->p(Landroid/os/Bundle;)I
    ...
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->f(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {}, Lcom/google/firebase/messaging/i0;->m()Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->k(Landroid/os/Bundle;)Lcom/google/firebase/messaging/reporting/MessagingClientEvent$MessageType;
    ...
    :cond_2
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->o(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->c(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->i(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_5
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->e(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_6
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->n(Landroid/os/Bundle;)J
...
.method static k(Landroid/os/Bundle;)Lcom/google/firebase/messaging/reporting/MessagingClientEvent$MessageType;
    ...
    invoke-static {p0}, Lcom/google/firebase/messaging/k0;->t(Landroid/os/Bundle;)Z
...
.method static n(Landroid/os/Bundle;)J
    ...
    invoke-virtual {v0}, Lcom/google/firebase/m;->f()Ljava/lang/String;
...
.method public static s(Landroid/content/Intent;)V
    ...
    invoke-static {v0, p0}, Lcom/google/firebase/messaging/i0;->x(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public static u(Landroid/os/Bundle;)V
    ...
    invoke-static {p0}, Lcom/google/firebase/messaging/i0;->z(Landroid/os/Bundle;)V
...
.method public static v(Landroid/content/Intent;)V
    ...
    invoke-static {p0}, Lcom/google/firebase/messaging/i0;->B(Landroid/content/Intent;)Z
    ...
    invoke-static {v1, v0}, Lcom/google/firebase/messaging/i0;->x(Ljava/lang/String;Landroid/os/Bundle;)V

    :cond_0
    invoke-static {p0}, Lcom/google/firebase/messaging/i0;->A(Landroid/content/Intent;)Z
    ...
    invoke-static {}, Lcom/google/firebase/messaging/FirebaseMessaging;->w()Ly4/h;

    move-result-object v1

    invoke-static {v0, p0, v1}, Lcom/google/firebase/messaging/i0;->w(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;Ly4/h;)V

    :cond_1
    return-void
.end method

.method private static w(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;Ly4/h;)V
    .locals 5
    ...
    :cond_0
    invoke-static {p0, p1}, Lcom/google/firebase/messaging/i0;->b(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;)Lcom/google/firebase/messaging/reporting/MessagingClientEvent;
    ...
    invoke-static {p1}, Ly4/e;->b(Ljava/lang/Integer;)Ly4/e;
    ...
    sget-object v4, Lcom/google/firebase/messaging/h0;->a:Lcom/google/firebase/messaging/h0;

    invoke-interface {p2, v1, v2, v3, v4}, Ly4/h;->a(Ljava/lang/String;Ljava/lang/Class;Ly4/c;Ly4/f;)Ly4/g;

    move-result-object p2

    invoke-static {}, Le8/a;->b()Le8/a$a;

    move-result-object v1

    invoke-virtual {v1, p0}, Le8/a$a;->b(Lcom/google/firebase/messaging/reporting/MessagingClientEvent;)Le8/a$a;

    move-result-object p0

    invoke-virtual {p0}, Le8/a$a;->a()Le8/a;

    move-result-object p0

    invoke-static {p0, p1}, Ly4/d;->f(Ljava/lang/Object;Ly4/e;)Ly4/d;

    move-result-object p0

    invoke-interface {p2, p0}, Ly4/g;->a(Ly4/d;)V
    :try_end_0
...
.method static x(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->d(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->g(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_5
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->j(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_6
    :goto_0
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->q(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_7
    :goto_1
    invoke-static {p1}, Lcom/google/firebase/messaging/i0;->l(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v2}, Lcom/google/firebase/f;->k(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v0, p0, v1}, Ly6/a;->a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method private static z(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v3}, Lcom/google/firebase/f;->k(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {v0, v1, v2, p0}, Ly6/a;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v0, v1, p0, v2}, Ly6/a;->a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
