...
.method private final c(Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState;Lne/h;Lne/k;)Z
    .locals 3
    ...
    invoke-interface {v0, p2}, Lne/m;->O(Lne/g;)Z
    ...
    invoke-interface {v0, p2}, Lne/m;->Q(Lne/h;)Z
...
.method private final e(Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState;Lne/h;Lne/h;)Z
    .locals 4
    ...
    invoke-interface {v0, p2}, Lne/m;->e(Lne/h;)Z
    ...
    invoke-interface {v0, v1}, Lne/m;->y(Lne/k;)Z

    move-result v1

    if-nez v1, :cond_0

    invoke-virtual {p1, p2}, Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState;->l(Lne/g;)Z

    move-result v1

    :cond_0
    invoke-interface {v0, p3}, Lne/m;->e(Lne/h;)Z

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual {p1, p3}, Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState;->l(Lne/g;)Z

    move-result v1

    :cond_1
    invoke-interface {v0, p3}, Lne/m;->x(Lne/h;)Z
    ...
    :cond_2
    invoke-interface {v0, p2}, Lne/m;->k(Lne/g;)Z
    ...
    invoke-interface {v0, v1}, Lne/m;->f0(Lne/b;)Z
    ...
    invoke-virtual {v1, p1, p2, v3}, Lkotlin/reflect/jvm/internal/impl/types/c;->a(Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState;Lne/h;Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState$a;)Z
    ...
    :cond_5
    invoke-interface {v0, p3}, Lne/m;->k(Lne/g;)Z
    ...
    invoke-virtual {v1, p1, p3, v2}, Lkotlin/reflect/jvm/internal/impl/types/c;->a(Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState;Lne/h;Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState$a;)Z
    ...
    :cond_8
    invoke-interface {v0, p3}, Lne/m;->d(Lne/h;)Lne/k;

    move-result-object p3

    invoke-virtual {v1, p1, p2, p3}, Lkotlin/reflect/jvm/internal/impl/types/c;->b(Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState;Lne/h;Lne/k;)Z
...
# virtual methods
.method public final a(Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState;Lne/h;Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState$a;)Z
    .locals 16
    ...
    invoke-interface {v2, v1}, Lne/m;->w0(Lne/h;)Z
    ...
    invoke-interface {v2, v1}, Lne/m;->x(Lne/h;)Z
    ...
    :cond_0
    invoke-interface {v2, v1}, Lne/m;->k(Lne/g;)Z
    ...
    :cond_5
    invoke-interface {v2, v8}, Lne/m;->x(Lne/h;)Z

    move-result v9

    if-eqz v9, :cond_6

    sget-object v9, Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState$a$c;->a:Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState$a$c;
    ...
    :goto_3
    sget-object v10, Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState$a$c;->a:Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState$a$c;
    ...
    invoke-interface {v10, v8}, Lne/m;->d(Lne/h;)Lne/k;

    move-result-object v8

    invoke-interface {v10, v8}, Lne/m;->V(Lne/k;)Ljava/util/Collection;
    ...
    check-cast v10, Lne/g;

    invoke-virtual {v9, v0, v10}, Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState$a;->a(Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState;Lne/g;)Lne/h;

    move-result-object v10

    invoke-interface {v2, v10}, Lne/m;->w0(Lne/h;)Z

    move-result v11

    if-eqz v11, :cond_9

    invoke-interface {v2, v10}, Lne/m;->x(Lne/h;)Z
    ...
    :cond_9
    invoke-interface {v2, v10}, Lne/m;->k(Lne/g;)Z
    ...
    invoke-static/range {v7 .. v15}, Lkotlin/collections/r;->g0(Ljava/lang/Iterable;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILjava/lang/CharSequence;Lod/l;ILjava/lang/Object;)Ljava/lang/String;
...
.method public final b(Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState;Lne/h;Lne/k;)Z
    .locals 12
    ...
    invoke-direct {v1, p1, p2, p3}, Lkotlin/reflect/jvm/internal/impl/types/c;->c(Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState;Lne/h;Lne/k;)Z
    ...
    invoke-direct {v7, p1, v6, p3}, Lkotlin/reflect/jvm/internal/impl/types/c;->c(Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState;Lne/h;Lne/k;)Z
...
.method public final d(Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState;Lne/h;Lne/h;)Z
    .locals 1
    ...
    invoke-direct {p0, p1, p2, p3}, Lkotlin/reflect/jvm/internal/impl/types/c;->e(Lkotlin/reflect/jvm/internal/impl/types/TypeCheckerState;Lne/h;Lne/h;)Z
