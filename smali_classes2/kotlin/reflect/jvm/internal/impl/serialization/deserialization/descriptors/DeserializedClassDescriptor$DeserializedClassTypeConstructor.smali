...
.method protected k()Ljava/util/Collection;
    ...
    invoke-virtual {v1}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor;->T0()Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/i;
    ...
    invoke-static {v0, v1}, Lee/f;->l(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Class;Lee/g;)Ljava/util/List;
    ...
    invoke-virtual {v5}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/i;->i()Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/TypeDeserializer;

    move-result-object v5

    invoke-virtual {v5, v4}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/TypeDeserializer;->p(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;)Lkotlin/reflect/jvm/internal/impl/types/c0;
    ...
    invoke-virtual {v0}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/g;->c()Lwd/a;

    move-result-object v0

    iget-object v1, p0, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassTypeConstructor;->e:Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor;

    invoke-interface {v0, v1}, Lwd/a;->d(Lkotlin/reflect/jvm/internal/impl/descriptors/d;)Ljava/util/Collection;

    move-result-object v0

    invoke-static {v2, v0}, Lkotlin/collections/r;->r0(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-virtual {v2}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/g;->i()Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/l;
    ...
    invoke-static {v3}, Lkotlin/reflect/jvm/internal/impl/resolve/descriptorUtil/DescriptorUtilsKt;->h(Lkotlin/reflect/jvm/internal/impl/descriptors/f;)Lkotlin/reflect/jvm/internal/impl/name/b;
    ...
    :cond_5
    invoke-interface {v2, v4, v5}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/l;->b(Lkotlin/reflect/jvm/internal/impl/descriptors/d;Ljava/util/List;)V
