...
.method public constructor <init>(Landroidx/camera/core/impl/g1;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/camera/core/impl/g1;->b(Ljava/lang/Class;)Landroidx/camera/core/impl/f1;
...
# virtual methods
.method public c(Landroidx/camera/camera2/internal/n2;Ljava/util/List;Ljava/util/List;Lt/g$a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    :goto_1
    invoke-direct {p0, v0}, Lt/g;->b(Ljava/util/Set;)V

    :cond_2
    invoke-interface {p4, p1}, Lt/g$a;->a(Landroidx/camera/camera2/internal/n2;)V
    ...
    :cond_4
    :goto_3
    invoke-direct {p0, p2}, Lt/g;->a(Ljava/util/Set;)V
