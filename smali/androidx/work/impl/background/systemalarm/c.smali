...
.method constructor <init>(Landroid/content/Context;ILandroidx/work/impl/background/systemalarm/e;)V
    ...
    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/e;->f()Lx1/a;
    ...
    invoke-direct {p3, p1, p2, v0}, Lr1/d;-><init>(Landroid/content/Context;Lx1/a;Lr1/c;)V

    iput-object p3, p0, Landroidx/work/impl/background/systemalarm/c;->d:Lr1/d;
...
.method a()V
    ...
    invoke-interface {v0}, Lv1/q;->g()Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/c;->d:Lr1/d;
    ...
    iget-object v5, v4, Lv1/p;->a:Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lv1/p;->b()Z

    move-result v6

    if-eqz v6, :cond_1

    iget-object v6, p0, Landroidx/work/impl/background/systemalarm/c;->d:Lr1/d;

    invoke-virtual {v6, v5}, Lr1/d;->c(Ljava/lang/String;)Z
    ...
    :cond_3
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/c;->d:Lr1/d;
