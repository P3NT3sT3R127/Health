...
.method public static a(Landroid/content/Context;Lo1/i;Ljava/lang/String;)V
    .locals 4
    ...
    invoke-virtual {p1}, Landroidx/work/impl/WorkDatabase;->y()Lv1/h;

    move-result-object p1

    invoke-interface {p1, p2}, Lv1/h;->b(Ljava/lang/String;)Lv1/g;
    ...
    invoke-interface {p1, p2}, Lv1/h;->c(Ljava/lang/String;)V
...
.method public static c(Landroid/content/Context;Lo1/i;Ljava/lang/String;J)V
    .locals 2
    ...
    invoke-interface {v0, p2}, Lv1/h;->b(Ljava/lang/String;)Lv1/g;

    move-result-object v1

    if-eqz v1, :cond_0

    iget p1, v1, Lv1/g;->b:I
    ...
    invoke-direct {v1, p1}, Lw1/c;-><init>(Landroidx/work/impl/WorkDatabase;)V
    ...
    invoke-direct {v1, p2, p1}, Lv1/g;-><init>(Ljava/lang/String;I)V

    invoke-interface {v0, v1}, Lv1/h;->d(Lv1/g;)V
