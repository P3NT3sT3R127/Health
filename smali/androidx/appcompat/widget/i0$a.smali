...
.method static constructor <clinit>()V
    ...
    :cond_0
    sput-object v2, Landroidx/appcompat/widget/i0$a;->b:Ljava/lang/reflect/Method;

    sput-object v2, Landroidx/appcompat/widget/i0$a;->c:Ljava/lang/reflect/Field;

    sput-object v2, Landroidx/appcompat/widget/i0$a;->d:Ljava/lang/reflect/Field;

    sput-object v2, Landroidx/appcompat/widget/i0$a;->e:Ljava/lang/reflect/Field;

    sput-object v2, Landroidx/appcompat/widget/i0$a;->f:Ljava/lang/reflect/Field;

    sput-boolean v1, Landroidx/appcompat/widget/i0$a;->a:Z
...
.method static a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    sget-boolean v0, Landroidx/appcompat/widget/i0$a;->a:Z

    if-eqz v0, :cond_0

    :try_start_0
    sget-object v0, Landroidx/appcompat/widget/i0$a;->b:Ljava/lang/reflect/Method;
    ...
    sget-object v1, Landroidx/appcompat/widget/i0$a;->c:Ljava/lang/reflect/Field;

    invoke-virtual {v1, p0}, Ljava/lang/reflect/Field;->getInt(Ljava/lang/Object;)I

    move-result v1

    sget-object v2, Landroidx/appcompat/widget/i0$a;->d:Ljava/lang/reflect/Field;

    invoke-virtual {v2, p0}, Ljava/lang/reflect/Field;->getInt(Ljava/lang/Object;)I

    move-result v2

    sget-object v3, Landroidx/appcompat/widget/i0$a;->e:Ljava/lang/reflect/Field;

    invoke-virtual {v3, p0}, Ljava/lang/reflect/Field;->getInt(Ljava/lang/Object;)I

    move-result v3

    sget-object v4, Landroidx/appcompat/widget/i0$a;->f:Ljava/lang/reflect/Field;
    ...
    :catch_0
    :cond_0
    sget-object p0, Landroidx/appcompat/widget/i0;->c:Landroid/graphics/Rect;
