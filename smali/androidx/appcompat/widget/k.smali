...
# instance fields
.field private a:Landroidx/appcompat/widget/q0;
...
.method public static declared-synchronized h()V
    ...
    iput-object v2, v1, Landroidx/appcompat/widget/k;->a:Landroidx/appcompat/widget/q0;

    sget-object v1, Landroidx/appcompat/widget/k;->c:Landroidx/appcompat/widget/k;

    iget-object v1, v1, Landroidx/appcompat/widget/k;->a:Landroidx/appcompat/widget/q0;

    new-instance v2, Landroidx/appcompat/widget/k$a;

    invoke-direct {v2}, Landroidx/appcompat/widget/k$a;-><init>()V

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/q0;->u(Landroidx/appcompat/widget/q0$f;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method static i(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/z0;[I)V
    .locals 0

    invoke-static {p0, p1, p2}, Landroidx/appcompat/widget/q0;->w(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/z0;[I)V
...
.method public declared-synchronized c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    iget-object v0, p0, Landroidx/appcompat/widget/k;->a:Landroidx/appcompat/widget/q0;

    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/q0;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method declared-synchronized d(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroidx/appcompat/widget/q0;->k(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
...
.method declared-synchronized f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/q0;->m(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public declared-synchronized g(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/q0;->s(Landroid/content/Context;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
