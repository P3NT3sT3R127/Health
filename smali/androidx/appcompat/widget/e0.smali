...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    :cond_1
    new-instance p1, Landroidx/appcompat/widget/e0$f;

    invoke-direct {p1}, Landroidx/appcompat/widget/e0$f;-><init>()V
...
.method private A(ILandroid/graphics/RectF;)Z
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/e0;->o(I)V
    ...
    invoke-static {p1, v4, v2}, Landroidx/appcompat/widget/e0;->p(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, p1, v2, v1}, Landroidx/appcompat/widget/e0;->e(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
...
.method private static a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_0
    invoke-static {p1}, Landroidx/appcompat/widget/e0;->m(Ljava/lang/String;)Ljava/lang/reflect/Field;
...
.method private f(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
    ...
    invoke-static {v0, v2, v1}, Landroidx/appcompat/widget/e0;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/e0;->h:Landroid/text/TextPaint;
...
.method private g(Landroid/graphics/RectF;)I
    ...
    invoke-direct {p0, v3, p1}, Landroidx/appcompat/widget/e0;->A(ILandroid/graphics/RectF;)Z
...
.method private static m(Ljava/lang/String;)Ljava/lang/reflect/Field;
    ...
    :try_start_0
    sget-object v0, Landroidx/appcompat/widget/e0;->n:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sget-object v1, Landroidx/appcompat/widget/e0;->n:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private static n(Ljava/lang/String;)Ljava/lang/reflect/Method;
    .locals 3
...
.method static p(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    :try_start_0
    invoke-static {p1}, Landroidx/appcompat/widget/e0;->n(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method private v(F)V
    ...
    invoke-static {v0}, Landroidx/appcompat/widget/e0;->n(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method private x()Z
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/e0;->B()Z
    ...
    :cond_1
    invoke-direct {p0, v3}, Landroidx/appcompat/widget/e0;->c([I)[I
...
.method private y(Landroid/content/res/TypedArray;)V
    ...
    :cond_0
    invoke-direct {p0, v1}, Landroidx/appcompat/widget/e0;->c([I)[I

    move-result-object p1

    iput-object p1, p0, Landroidx/appcompat/widget/e0;->f:[I

    invoke-direct {p0}, Landroidx/appcompat/widget/e0;->z()Z
...
.method b()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/e0;->q()Z
    ...
    invoke-direct {p0, v2}, Landroidx/appcompat/widget/e0;->g(Landroid/graphics/RectF;)I
    ...
    invoke-virtual {p0, v1, v0}, Landroidx/appcompat/widget/e0;->w(IF)V
...
.method e(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/e0;->i:Landroid/widget/TextView;

    iget-object v7, p0, Landroidx/appcompat/widget/e0;->h:Landroid/text/TextPaint;

    iget-object v8, p0, Landroidx/appcompat/widget/e0;->k:Landroidx/appcompat/widget/e0$f;
    ...
    invoke-static/range {v2 .. v8}, Landroidx/appcompat/widget/e0$c;->a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;IILandroid/widget/TextView;Landroid/text/TextPaint;Landroidx/appcompat/widget/e0$f;)Landroid/text/StaticLayout;
    ...
    iget-object p4, p0, Landroidx/appcompat/widget/e0;->i:Landroid/widget/TextView;

    iget-object v0, p0, Landroidx/appcompat/widget/e0;->h:Landroid/text/TextPaint;

    invoke-static {p1, p2, p3, p4, v0}, Landroidx/appcompat/widget/e0$a;->a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;ILandroid/widget/TextView;Landroid/text/TextPaint;)Landroid/text/StaticLayout;
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Landroidx/appcompat/widget/e0;->f(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
...
.method r(Landroid/util/AttributeSet;I)V
    .locals 9
    ...
    invoke-static/range {v1 .. v7}, Landroidx/core/view/a0;->q0(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V
    ...
    invoke-direct {p0, v3}, Landroidx/appcompat/widget/e0;->y(Landroid/content/res/TypedArray;)V
    ...
    :cond_7
    invoke-direct {p0, p2, v2, p1}, Landroidx/appcompat/widget/e0;->C(FFF)V

    :cond_8
    invoke-direct {p0}, Landroidx/appcompat/widget/e0;->x()Z
...
.method s(IIII)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/appcompat/widget/e0;->C(FFF)V
...
.method t([II)V
    ...
    :cond_1
    :goto_1
    invoke-direct {p0, v2}, Landroidx/appcompat/widget/e0;->c([I)[I
...
.method u(I)V
    ...
    invoke-direct {p0, v0, p1, v1}, Landroidx/appcompat/widget/e0;->C(FFF)V
    ...
    :cond_1
    invoke-direct {p0}, Landroidx/appcompat/widget/e0;->d()V
...
.method w(IF)V
    ...
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/e0;->v(F)V
