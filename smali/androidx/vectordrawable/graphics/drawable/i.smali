...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/vectordrawable/graphics/drawable/i;->q:Landroid/graphics/PorterDuff$Mode;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i;->n:[F

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i;->o:Landroid/graphics/Matrix;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i;->p:Landroid/graphics/Rect;
...
.method public static b(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroidx/vectordrawable/graphics/drawable/i;
    ...
    iput-object p0, v0, Landroidx/vectordrawable/graphics/drawable/i;->m:Landroid/graphics/drawable/Drawable$ConstantState;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/i;->p:Landroid/graphics/Rect;
    ...
    :cond_2
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/i;->o:Landroid/graphics/Matrix;

    invoke-virtual {p1, v1}, Landroid/graphics/Canvas;->getMatrix(Landroid/graphics/Matrix;)V

    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/i;->o:Landroid/graphics/Matrix;

    iget-object v2, p0, Landroidx/vectordrawable/graphics/drawable/i;->n:[F

    invoke-virtual {v1, v2}, Landroid/graphics/Matrix;->getValues([F)V

    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/i;->n:[F
    ...
    iget-object v3, p0, Landroidx/vectordrawable/graphics/drawable/i;->n:[F
    ...
    iget-object v4, p0, Landroidx/vectordrawable/graphics/drawable/i;->n:[F
    ...
    iget-object v5, p0, Landroidx/vectordrawable/graphics/drawable/i;->n:[F
    ...
    :cond_4
    iget-object v4, p0, Landroidx/vectordrawable/graphics/drawable/i;->p:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, Landroidx/vectordrawable/graphics/drawable/i;->p:Landroid/graphics/Rect;
    ...
    iget-boolean v2, p0, Landroidx/vectordrawable/graphics/drawable/i;->l:Z
    ...
    iget-object v2, p0, Landroidx/vectordrawable/graphics/drawable/i;->p:Landroid/graphics/Rect;
...
.method h(Z)V
    ...
    iput-boolean p1, p0, Landroidx/vectordrawable/graphics/drawable/i;->l:Z
...
.method public mutate()Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-boolean v0, p0, Landroidx/vectordrawable/graphics/drawable/i;->g:Z
