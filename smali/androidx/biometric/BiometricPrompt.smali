...
.method public constructor <init>(Landroidx/fragment/app/e;Ljava/util/concurrent/Executor;Landroidx/biometric/BiometricPrompt$a;)V
    ...
    invoke-direct {p0, v0, p1, p2, p3}, Landroidx/biometric/BiometricPrompt;->g(Landroidx/fragment/app/m;Landroidx/biometric/f;Ljava/util/concurrent/Executor;Landroidx/biometric/BiometricPrompt$a;)V
...
.method private b(Landroidx/biometric/BiometricPrompt$d;Landroidx/biometric/BiometricPrompt$c;)V
    ...
    iget-object v0, p0, Landroidx/biometric/BiometricPrompt;->a:Landroidx/fragment/app/m;
    ...
    invoke-static {v0}, Landroidx/biometric/BiometricPrompt;->e(Landroidx/fragment/app/m;)Landroidx/biometric/d;

    move-result-object v0

    invoke-virtual {v0, p1, p2}, Landroidx/biometric/d;->k(Landroidx/biometric/BiometricPrompt$d;Landroidx/biometric/BiometricPrompt$c;)V

    return-void
.end method

.method private static d(Landroidx/fragment/app/m;)Landroidx/biometric/d;
    .locals 1

    const-string v0, "androidx.biometric.BiometricFragment"

    invoke-virtual {p0, v0}, Landroidx/fragment/app/m;->k0(Ljava/lang/String;)Landroidx/fragment/app/Fragment;
...
.method private static e(Landroidx/fragment/app/m;)Landroidx/biometric/d;
    .locals 3

    invoke-static {p0}, Landroidx/biometric/BiometricPrompt;->d(Landroidx/fragment/app/m;)Landroidx/biometric/d;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-static {}, Landroidx/biometric/d;->z()Landroidx/biometric/d;

    move-result-object v0

    invoke-virtual {p0}, Landroidx/fragment/app/m;->m()Landroidx/fragment/app/v;

    move-result-object v1

    const-string v2, "androidx.biometric.BiometricFragment"

    invoke-virtual {v1, v0, v2}, Landroidx/fragment/app/v;->e(Landroidx/fragment/app/Fragment;Ljava/lang/String;)Landroidx/fragment/app/v;

    move-result-object v1

    invoke-virtual {v1}, Landroidx/fragment/app/v;->h()I
...
.method private g(Landroidx/fragment/app/m;Landroidx/biometric/f;Ljava/util/concurrent/Executor;Landroidx/biometric/BiometricPrompt$a;)V
    .locals 0

    iput-object p1, p0, Landroidx/biometric/BiometricPrompt;->a:Landroidx/fragment/app/m;
...
.method public c()V
    ...
    :cond_0
    invoke-static {v0}, Landroidx/biometric/BiometricPrompt;->d(Landroidx/fragment/app/m;)Landroidx/biometric/d;
    ...
    invoke-virtual {v0, v1}, Landroidx/biometric/d;->n(I)V
