.class Landroidx/camera/camera2/internal/compat/h0;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/camera/camera2/internal/compat/h0$a;
    }
.end annotation
...
.method constructor <init>(Landroid/hardware/camera2/CameraDevice;Ljava/lang/Object;)V
    ...
    iput-object p1, p0, Landroidx/camera/camera2/internal/compat/h0;->a:Landroid/hardware/camera2/CameraDevice;

    iput-object p2, p0, Landroidx/camera/camera2/internal/compat/h0;->b:Ljava/lang/Object;
...
.method private static b(Landroid/hardware/camera2/CameraDevice;Ljava/util/List;)V
    ...
    invoke-virtual {v0}, Lr/b;->a()Ljava/lang/String;
...
.method static c(Landroid/hardware/camera2/CameraDevice;Lr/g;)V
    .locals 1
    ...
    invoke-static {p0, v0}, Landroidx/camera/camera2/internal/compat/h0;->b(Landroid/hardware/camera2/CameraDevice;Ljava/util/List;)V
...
.method static d(Landroid/hardware/camera2/CameraDevice;Landroid/os/Handler;)Landroidx/camera/camera2/internal/compat/h0;
    .locals 2

    new-instance v0, Landroidx/camera/camera2/internal/compat/h0;
    ...
    invoke-direct {v0, p0, v1}, Landroidx/camera/camera2/internal/compat/h0;-><init>(Landroid/hardware/camera2/CameraDevice;Ljava/lang/Object;)V
...
.method static f(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Lr/b;->b()Landroid/view/Surface;
...
.method public a(Lr/g;)V
    ...
    invoke-static {p1}, Landroidx/camera/camera2/internal/compat/h0;->f(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iget-object v1, p0, Landroidx/camera/camera2/internal/compat/h0;->b:Ljava/lang/Object;

    check-cast v1, Landroidx/camera/camera2/internal/compat/h0$a;

    iget-object v2, p0, Landroidx/camera/camera2/internal/compat/h0;->a:Landroid/hardware/camera2/CameraDevice;

    iget-object v1, v1, Landroidx/camera/camera2/internal/compat/h0$a;->a:Landroid/os/Handler;

    invoke-virtual {p0, v2, p1, v0, v1}, Landroidx/camera/camera2/internal/compat/h0;->e(Landroid/hardware/camera2/CameraDevice;Ljava/util/List;Landroid/hardware/camera2/CameraCaptureSession$StateCallback;Landroid/os/Handler;)V
