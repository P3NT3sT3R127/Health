...
.method constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Landroidx/camera/camera2/internal/compat/o0;-><init>(Landroid/content/Context;Ljava/lang/Object;)V

    return-void
.end method

.method static h(Landroid/content/Context;)Landroidx/camera/camera2/internal/compat/m0;
    .locals 1

    new-instance v0, Landroidx/camera/camera2/internal/compat/m0;

    invoke-direct {v0, p0}, Landroidx/camera/camera2/internal/compat/m0;-><init>(Landroid/content/Context;)V
...
.method private i(Ljava/lang/Throwable;)Z
    ...
    invoke-static {p1}, Landroidx/camera/camera2/internal/compat/m0;->j(Ljava/lang/Throwable;)Z
...
.method public c(Ljava/lang/String;)Landroid/hardware/camera2/CameraCharacteristics;
    ...
    :try_start_0
    invoke-super {p0, p1}, Landroidx/camera/camera2/internal/compat/o0;->c(Ljava/lang/String;)Landroid/hardware/camera2/CameraCharacteristics;
    ...
    invoke-direct {p0, p1}, Landroidx/camera/camera2/internal/compat/m0;->i(Ljava/lang/Throwable;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0, p1}, Landroidx/camera/camera2/internal/compat/m0;->k(Ljava/lang/Throwable;)V
