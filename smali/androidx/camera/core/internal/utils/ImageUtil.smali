...
.method public static a(Landroid/util/Size;Landroid/util/Rational;)Landroid/graphics/Rect;
    ...
    invoke-static {p0, p1}, Landroidx/camera/core/p1;->k(Ljava/lang/String;Ljava/lang/String;)V
...
.method private static c([BLandroid/graphics/Rect;I)[B
    .locals 3
...
.method private static h(Landroid/util/Size;Landroid/util/Rational;)Z
    .locals 3
...
.method public static i(Landroidx/camera/core/i1;)[B
    .locals 3
...
.method public static j(Landroidx/camera/core/i1;Landroid/graphics/Rect;I)[B
    .locals 2
    ...
    invoke-static {p0}, Landroidx/camera/core/internal/utils/ImageUtil;->i(Landroidx/camera/core/i1;)[B
...
.method private static l([BIILandroid/graphics/Rect;I)[B
    .locals 8
...
.method public static n(Landroidx/camera/core/i1;)Z
    .locals 3
    ...
    invoke-interface {p0}, Landroidx/camera/core/i1;->w()Landroid/graphics/Rect;
...
.method public static p(Landroidx/camera/core/i1;Landroid/graphics/Rect;I)[B
    .locals 2
    ...
    invoke-static {p0}, Landroidx/camera/core/internal/utils/ImageUtil;->q(Landroidx/camera/core/i1;)[B
...
.method public static q(Landroidx/camera/core/i1;)[B
    .locals 19
    ...
    invoke-interface {v3}, Landroidx/camera/core/i1$a;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v3}, Landroidx/camera/core/i1$a;->a()I

    move-result v4

    invoke-interface {v2}, Landroidx/camera/core/i1$a;->a()I

    move-result v8

    invoke-interface {v3}, Landroidx/camera/core/i1$a;->b()I

    move-result v3

    invoke-interface {v2}, Landroidx/camera/core/i1$a;->b()I
