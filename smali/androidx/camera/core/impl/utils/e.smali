...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Landroidx/camera/core/impl/utils/e;->n()Ljava/util/List;
...
.method private constructor <init>(Ls0/a;)V
    .locals 1
    ...
    iput-object p1, p0, Landroidx/camera/core/impl/utils/e;->a:Ls0/a;
...
.method private a()V
    ...
    invoke-static {v0, v1}, Landroidx/camera/core/impl/utils/e;->f(J)Ljava/lang/String;

    move-result-object v2

    iget-object v3, p0, Landroidx/camera/core/impl/utils/e;->a:Ls0/a;

    const-string v4, "DateTime"

    invoke-virtual {v3, v4, v2}, Ls0/a;->g0(Ljava/lang/String;Ljava/lang/String;)V

    :try_start_0
    invoke-static {v2}, Landroidx/camera/core/impl/utils/e;->d(Ljava/lang/String;)Ljava/util/Date;
    ...
    iget-object v1, p0, Landroidx/camera/core/impl/utils/e;->a:Ls0/a;

    const-string v2, "SubSecTime"

    invoke-virtual {v1, v2, v0}, Ls0/a;->g0(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
...
.method public static h(Ljava/io/File;)Landroidx/camera/core/impl/utils/e;
    .locals 0
    ...
    invoke-static {p0}, Landroidx/camera/core/impl/utils/e;->i(Ljava/lang/String;)Landroidx/camera/core/impl/utils/e;
...
.method public static i(Ljava/lang/String;)Landroidx/camera/core/impl/utils/e;
    .locals 2
    ...
    invoke-direct {v1, p0}, Ls0/a;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v1}, Landroidx/camera/core/impl/utils/e;-><init>(Ls0/a;)V

    return-object v0
.end method

.method public static j(Landroidx/camera/core/i1;)Landroidx/camera/core/impl/utils/e;
    .locals 1
    ...
    invoke-static {p0}, Landroidx/camera/core/impl/utils/e;->k(Ljava/io/InputStream;)Landroidx/camera/core/impl/utils/e;
...
.method public static k(Ljava/io/InputStream;)Landroidx/camera/core/impl/utils/e;
    .locals 2
    ...
    invoke-direct {v1, p0}, Ls0/a;-><init>(Ljava/io/InputStream;)V
...
.method private x(Ljava/lang/String;)J
    ...
    :cond_0
    :try_start_0
    invoke-static {p1}, Landroidx/camera/core/impl/utils/e;->d(Ljava/lang/String;)Ljava/util/Date;
...
.method private y(Ljava/lang/String;Ljava/lang/String;)J
    ...
    :try_start_0
    invoke-static {p1}, Landroidx/camera/core/impl/utils/e;->c(Ljava/lang/String;)Ljava/util/Date;
    ...
    :try_start_1
    invoke-static {p2}, Landroidx/camera/core/impl/utils/e;->e(Ljava/lang/String;)Ljava/util/Date;
    ...
    invoke-direct {p0, p1}, Landroidx/camera/core/impl/utils/e;->x(Ljava/lang/String;)J
...
.method public A()V
    ...
    iget-boolean v0, p0, Landroidx/camera/core/impl/utils/e;->b:Z

    if-nez v0, :cond_0

    invoke-direct {p0}, Landroidx/camera/core/impl/utils/e;->a()V

    :cond_0
    iget-object v0, p0, Landroidx/camera/core/impl/utils/e;->a:Ls0/a;

    invoke-virtual {v0}, Ls0/a;->b0()V
...
.method public b(Landroid/location/Location;)V
    ...
    invoke-virtual {v0, p1}, Ls0/a;->h0(Landroid/location/Location;)V

    return-void
.end method

.method public g(Landroidx/camera/core/impl/utils/e;)V
    .locals 4

    new-instance v0, Ljava/util/ArrayList;

    sget-object v1, Landroidx/camera/core/impl/utils/e;->g:Ljava/util/List;

    invoke-direct {v0, v1}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    sget-object v1, Landroidx/camera/core/impl/utils/e;->h:Ljava/util/List;
    ...
    iget-object v2, p0, Landroidx/camera/core/impl/utils/e;->a:Ls0/a;

    invoke-virtual {v2, v1}, Ls0/a;->m(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    if-eqz v2, :cond_0

    iget-object v3, p1, Landroidx/camera/core/impl/utils/e;->a:Ls0/a;

    invoke-virtual {v3, v1, v2}, Ls0/a;->g0(Ljava/lang/String;Ljava/lang/String;)V
...
.method public l()V
    ...
    invoke-virtual {p0}, Landroidx/camera/core/impl/utils/e;->r()I
...
.method public o()Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Ls0/a;->m(Ljava/lang/String;)Ljava/lang/String;
...
.method public p()I
    ...
    invoke-virtual {v0, v1, v2}, Ls0/a;->o(Ljava/lang/String;I)I
...
.method public q()Landroid/location/Location;
    ...
    iget-object v1, v0, Landroidx/camera/core/impl/utils/e;->a:Ls0/a;

    const-string v2, "GPSProcessingMethod"

    invoke-virtual {v1, v2}, Ls0/a;->m(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iget-object v2, v0, Landroidx/camera/core/impl/utils/e;->a:Ls0/a;

    invoke-virtual {v2}, Ls0/a;->s()[D

    move-result-object v2

    iget-object v3, v0, Landroidx/camera/core/impl/utils/e;->a:Ls0/a;

    const-wide/16 v4, 0x0

    invoke-virtual {v3, v4, v5}, Ls0/a;->l(D)D
    ...
    invoke-virtual {v3, v8, v4, v5}, Ls0/a;->n(Ljava/lang/String;D)D
    ...
    invoke-virtual {v3, v10}, Ls0/a;->m(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v11, v0, Landroidx/camera/core/impl/utils/e;->a:Ls0/a;

    const-string v12, "GPSDateStamp"

    invoke-virtual {v11, v12}, Ls0/a;->m(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v11

    iget-object v12, v0, Landroidx/camera/core/impl/utils/e;->a:Ls0/a;

    const-string v13, "GPSTimeStamp"

    invoke-virtual {v12, v13}, Ls0/a;->m(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v12

    invoke-direct {v0, v11, v12}, Landroidx/camera/core/impl/utils/e;->y(Ljava/lang/String;Ljava/lang/String;)J
...
.method public t()J
    ...
    invoke-direct {p0, v0}, Landroidx/camera/core/impl/utils/e;->x(Ljava/lang/String;)J
    ...
    invoke-virtual {v2, v3}, Ls0/a;->m(Ljava/lang/String;)Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Landroidx/camera/core/impl/utils/e;->u()I
    ...
    invoke-virtual {p0}, Landroidx/camera/core/impl/utils/e;->p()I
    ...
    invoke-virtual {p0}, Landroidx/camera/core/impl/utils/e;->s()I
    ...
    invoke-virtual {p0}, Landroidx/camera/core/impl/utils/e;->w()Z
    ...
    invoke-virtual {p0}, Landroidx/camera/core/impl/utils/e;->v()Z
    ...
    invoke-virtual {p0}, Landroidx/camera/core/impl/utils/e;->q()Landroid/location/Location;
    ...
    invoke-virtual {p0}, Landroidx/camera/core/impl/utils/e;->t()J
    ...
    invoke-virtual {p0}, Landroidx/camera/core/impl/utils/e;->o()Ljava/lang/String;
...
.method public z(I)V
    ...
    sget-object v0, Landroidx/camera/core/impl/utils/e;->c:Ljava/lang/String;
    ...
    iget-object p1, p0, Landroidx/camera/core/impl/utils/e;->a:Ls0/a;
    ...
    :goto_0
    invoke-virtual {p1, v1, v0}, Ls0/a;->g0(Ljava/lang/String;Ljava/lang/String;)V
