...
# direct methods
.method public static a(Landroid/content/Context;Landroidx/camera/core/impl/s;Landroidx/camera/core/p;)V
    .locals 4
    ...
    :try_start_0
    invoke-virtual {p2}, Landroidx/camera/core/p;->d()Ljava/lang/Integer;
    ...
    invoke-static {v0, p0}, Landroidx/camera/core/p1;->k(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-static {v0, p1, p0}, Landroidx/camera/core/p1;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0, v2}, Landroidx/camera/core/p1;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_2
    sget-object v2, Landroidx/camera/core/p;->c:Landroidx/camera/core/p;

    invoke-virtual {p1}, Landroidx/camera/core/impl/s;->a()Ljava/util/LinkedHashSet;

    move-result-object v3

    invoke-virtual {v2, v3}, Landroidx/camera/core/p;->e(Ljava/util/LinkedHashSet;)Landroidx/camera/core/impl/CameraInternal;
    ...
    :cond_4
    sget-object p0, Landroidx/camera/core/p;->b:Landroidx/camera/core/p;

    invoke-virtual {p1}, Landroidx/camera/core/impl/s;->a()Ljava/util/LinkedHashSet;

    move-result-object p2

    invoke-virtual {p0, p2}, Landroidx/camera/core/p;->e(Ljava/util/LinkedHashSet;)Landroidx/camera/core/impl/CameraInternal;
    :try_end_1
