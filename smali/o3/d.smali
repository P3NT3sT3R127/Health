...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lo3/d;->a:Ljava/util/List;
...
# virtual methods
.method public declared-synchronized a(Lo3/b;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    iget-object v0, p0, Lo3/d;->a:Ljava/util/List;
...
.method public declared-synchronized onFailure(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :try_start_1
    iget-object v2, p0, Lo3/d;->a:Ljava/util/List;
    ...
    invoke-interface {v2, p1, p2}, Lo3/b;->onFailure(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_1
    ...
    invoke-direct {p0, v3, v2}, Lo3/d;->c(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_2
...
.method public declared-synchronized onFinalImageSet(Ljava/lang/String;Ljava/lang/Object;Landroid/graphics/drawable/Animatable;)V
    ...
    invoke-interface {v2, p1, p2, p3}, Lo3/b;->onFinalImageSet(Ljava/lang/String;Ljava/lang/Object;Landroid/graphics/drawable/Animatable;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public onIntermediateImageFailed(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v2, p1, p2}, Lo3/b;->onIntermediateImageFailed(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_0
...
.method public onIntermediateImageSet(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v2, p1, p2}, Lo3/b;->onIntermediateImageSet(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public declared-synchronized onRelease(Ljava/lang/String;)V
    ...
    invoke-interface {v2, p1}, Lo3/b;->onRelease(Ljava/lang/String;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized onSubmit(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v2, p1, p2}, Lo3/b;->onSubmit(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
