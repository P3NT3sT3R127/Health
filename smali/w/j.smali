...
.method public static a(Landroid/graphics/Rect;ZLandroid/util/Rational;IIILjava/util/Map;)Ljava/util/Map;
    ...
    invoke-static/range {v2 .. v7}, Lw/j;->g(Landroid/graphics/RectF;Landroid/util/Rational;IZII)Landroid/graphics/RectF;
...
.method private static b(ZILandroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p0}, Lw/j;->d(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {p0, p1}, Lw/j;->c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p0}, Lw/j;->c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
...
.method private static c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {v1, p1}, Lw/j;->e(FF)F
    ...
    invoke-static {v3, p1}, Lw/j;->e(FF)F
...
.method private static d(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {v2, p1}, Lw/j;->f(FF)F
    ...
    invoke-static {p0, p1}, Lw/j;->f(FF)F
...
.method public static g(Landroid/graphics/RectF;Landroid/util/Rational;IZII)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p4}, Lw/j;->h(ZI)Z

    move-result p2

    invoke-static {p2, p5, p0, p1}, Lw/j;->b(ZILandroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
