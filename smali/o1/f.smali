...
.method static a(Landroid/content/Context;Lo1/i;)Lo1/e;
    .locals 4
    ...
    invoke-direct {v0, p0, p1}, Lq1/b;-><init>(Landroid/content/Context;Lo1/i;)V

    const-class p1, Landroidx/work/impl/background/systemjob/SystemJobService;

    invoke-static {p0, p1, v2}, Lw1/d;->a(Landroid/content/Context;Ljava/lang/Class;Z)V

    invoke-static {}, Landroidx/work/k;->c()Landroidx/work/k;

    move-result-object p0

    sget-object p1, Lo1/f;->a:Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p0}, Lo1/f;->c(Landroid/content/Context;)Lo1/e;
...
.method public static b(Landroidx/work/a;Landroidx/work/impl/WorkDatabase;Ljava/util/List;)V
    ...
    invoke-interface {v0, p0}, Lv1/q;->f(I)Ljava/util/List;

    move-result-object p0

    const/16 v1, 0xc8

    invoke-interface {v0, v1}, Lv1/q;->s(I)Ljava/util/List;
    ...
    invoke-interface {v0, v5, v2, v3}, Lv1/q;->c(Ljava/lang/String;J)I
    ...
    invoke-interface {v0}, Lo1/e;->a()Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-interface {v0, p0}, Lo1/e;->f([Lv1/p;)V
    ...
    invoke-interface {p2}, Lo1/e;->a()Z

    move-result v0

    if-nez v0, :cond_4

    invoke-interface {p2, p0}, Lo1/e;->f([Lv1/p;)V
...
.method private static c(Landroid/content/Context;)Lo1/e;
    .locals 7
    ...
    sget-object v3, Lo1/f;->a:Ljava/lang/String;
